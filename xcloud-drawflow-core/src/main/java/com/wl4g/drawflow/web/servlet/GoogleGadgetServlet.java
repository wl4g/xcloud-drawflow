 ...
 */
@WebServlet(urlPatterns = { "/gadget.xml" })
public class GoogleGadgetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Could use makeRequest with lower refreshInterval for getting data
		// from
		// URLs and possibly, using OAUTH, for getting Drive file contents
		// without
		...
		out.write(("<Module>\n" + "<ModulePrefs title=\"" + title + "\" height=\"" + height + "\"\n"
				...
				+ ((showEmbed) ? "<UserPref name=\"x0\" display_name=\"Left (Embed)\" datatype=\"string\" default_value=\"" + x0
						+ "\"></UserPref>\n"
						+ "<UserPref name=\"y0\" display_name=\"Top (Embed)\" datatype=\"string\" default_value=\"" + y0
						+ "\"></UserPref>\n"
						+ "<UserPref name=\"border\" display_name=\"Border (Embed)\" datatype=\"string\" default_value=\"" + b
						+ "\"></UserPref>\n"
						+ "<UserPref name=\"zoom\" display_name=\"Zoom enabled (Embed)\" datatype=\"bool\" default_value=\""
						+ ((zoom.equals("1")) ? "true" : "false") + "\"></UserPref>\n"
						+ "<UserPref name=\"pan\" display_name=\"Panning enabled (Embed)\" datatype=\"bool\" default_value=\""
						+ ((pan.equals("1")) ? "true" : "false") + "\"></UserPref>\n"
						+ "<UserPref name=\"fit\" display_name=\"Fit diagram to gadget (Embed)\" datatype=\"bool\" default_value=\""
						+ ((fit.equals("1")) ? "true" : "false") + "\"></UserPref>\n"
						+ "<UserPref name=\"resize\" display_name=\"Resize container (Embed)\" datatype=\"bool\" default_value=\""
						+ ((resize.equals("1")) ? "true" : "false") + "\"></UserPref>\n"
						+ "<UserPref name=\"math\" display_name=\"Mathematical typesetting (Embed)\" datatype=\"bool\" default_value=\""
						+ ((math.equals("1")) ? "true" : "false") + "\"></UserPref>\n"
						+ "<UserPref name=\"edit\" display_name=\"Edit URL (Embed)\" datatype=\"string\" default_value=\"" + edit
						+ "\"></UserPref>\n"
						+ "<UserPref name=\"stencils\" display_name=\"Stencils (Embed)\" datatype=\"string\" default_value=\"" + s
						+ "\"></UserPref>\n" : "")
