...
public class Utils {
	...
	public static String generateToken(int length) {
		...
		for (int i = 0; i < length; i++) {
			rtn.append(TOKEN_ALPHABET.charAt((int) Math.floor(Math.random() * TOKEN_ALPHABET.length())));
		}
	...
	/**
	 * Copies the input stream to the output stream using the default buffer
	 * size
	 * 
	 * @param in
	 *            the input stream
	...
	/**
	 * Copies the input stream to the output stream using the specified buffer
	 * size
	 * 
	 * @param in
	 *            the input stream
	 ...
	 * @param charset
	 *            the character set to base the encoding on
	...
	public static String encodeURIComponent(String s, String charset) {
		if (s == null) {
			...
			try {
				result = URLEncoder.encode(s, charset).replaceAll("\\+", "%20").replaceAll("\\%21", "!").replaceAll("\\%27", "'")
	...
	/**
	 * Checks the file type of an input stream and returns the bytes that have
	 * been read (because URL connections to not have support for mark/reset).
	 */
	static public byte[] checkStreamContent(InputStream is) throws IOException, UnsupportedContentException {
		...
		if (is.read(head) == head.length) {
			...
			if (c1 == 0x00 && c2 == 0x00 && c3 == 0xfe && c4 == 0xff) {
				if (c5 == 0 && c6 == 0 && c7 == 0 && c8 == '<' && c9 == 0 && c10 == 0 && c11 == 0 && c12 == '?' && c13 == 0
						&& c14 == 0 && c15 == 0 && c16 == 'x') {
					valid = true;
				}
			}
			...
			if (c1 == 0xff && c2 == 0xfe && c3 == 0x00 && c4 == 0x00) {
				if (c5 == '<' && c6 == 0 && c7 == 0 && c8 == 0 && c9 == '?' && c10 == 0 && c11 == 0 && c12 == 0 && c13 == 'x'
						&& c14 == 0 && c15 == 0 && c16 == 0) {
					valid = true;
				}
			}
			...
			if (c1 == 0xFF && c2 == 0xD8 && c3 == 0xFF) {
				 ...
				 * Format can be read by any application supporting JPEG. Exif
			...
			// ttf
			if (c1 == 0x00 && c2 == 0x01 && c3 == 0x00 && c4 == 0x00 && c5 == 0x00) {
				valid = true;
			}

			// otf
			if (c1 == 0x4F && c2 == 0x54 && c3 == 0x54 && c4 == 0x4F && c5 == 0x00) {
				valid = true;
			}
			...
			// vsdx, vssx (also zip, jar, odt, ods, odp, docx, xlsx, pptx, apk,
			// aar)
			...
			if (c1 == '<' && c2 == 'D' && c3 == 'O' && c4 == 'C' && c5 == 'T' && c6 == 'Y' && c7 == 'P' && c8 == 'E') {
				valid = true;
			}

			if (c1 == '<' && c2 == '!' && c3 == '-' && c4 == '-' && c5 == '[' && c6 == 'i' && c7 == 'f' && c8 == ' ') {
				valid = true;
			}

			// Gliffy
			if (c1 == '{' && c2 == '"' && c3 == 'c' && c4 == 'o' && c5 == 'n' && c6 == 't' && c7 == 'e' && c8 == 'n' && c9 == 't'
					&& c10 == 'T' && c11 == 'y' && c12 == 'p' && c13 == 'e' && c14 == '"' && c15 == ':') {
				valid = true;
			}

			// Lucidchart
			if (c1 == '{' && c2 == '"' && c3 == 's' && c4 == 't' && c5 == 'a' && c6 == 't' && c7 == 'e' && c8 == '"'
					&& c9 == ':') {
				valid = true;
			}
		}
