...
import com.wl4g.drawflow.io.mxCodecRegistry;
...
public class mxUtils {
	 ...
	 */
	public static mxRectangle getScaledLabelBounds(double x, double y, mxRectangle size, double outerWidth, double outerHeight,
	...
	public static Element createTable(Document document, String text, int x, int y, int w, int h, double scale,
		...
		if (text != null && text.length() > 0) {
			...
			String s = "position:absolute;" + "left:" + String.valueOf(x) + "px;" + "top:" + String.valueOf(y) + "px;" + "width:"
					+ String.valueOf(w) + "px;" + "height:" + String.valueOf(h) + "px;" + "font-size:" + String.valueOf(fontSize)
					+ "px;" + "font-family:" + fontFamily + ";" + "color:" + fontColor + ";";
	...
	/**
	 * Returns a new DOM document for the given URI. External entities and DTDs
	 * are ignored.
	 * 
	 * @param uri
