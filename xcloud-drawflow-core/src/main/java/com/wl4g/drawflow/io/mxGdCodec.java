 ...
 * This class depends from the classes contained incom.wl4g.drawflow.io.gd.
 */
public class mxGdCodec {
	...
	/**
	 * Generates a GD text output with the cells in the graph. The
	 * implementation only uses the cells located in the default parent.
	 * 
	 * @param graph
