...
import com.wl4g.drawflow.view.mxGraph.mxICellVisitor;
...
public class mxTraversal {
	 ...
	 * The visitor has access to the current cell and the edge traversed to find
	 * this cell. Every cell is processed once only.
	 * 
	 * <pre>
	 ...
	 * Process on the cell is performing by the visitor class passed in. The
	 * visitor has access to the current cell and the edge traversed to find
	 * this cell. Every cell is processed once only.
	 * 
	 * <pre>
	 ...
	 *             - The current Dijkstra algorithm only works for connected
	 *             graphs
	 */
	...
	/**
	 * Implements the Bellman-Ford shortest path from startVertex to all
	 * vertices.
	 * 
	 * @param aGraph
	 * @param startVertex
	 * @return a List where List(0) is the distance map and List(1) is the
	 *         parent map. See the example in GraphConfigDialog.java
	 * @throws StructuralException
	...
	/**
	 * Implements the Floyd-Roy-Warshall (aka WFI) shortest path algorithm
	 * between all vertices.
	 * 
	 * @param aGraph
	 * @return an ArrayList where ArrayList(0) is the distance map and List(1)
	 *         is the path map. See the example in GraphConfigDialog.java
	 * @throws StructuralException
	 *             - The Floyd-Roy-Warshall algorithm only works for graphs
	 ...
	 * @param startVertex
	 * @param targetVertex
	 * @return returns the shortest path from <b>startVertex</b> to
	 *         <b>endVertex</b>
	 * @throws StructuralException
	 *             - The Floyd-Roy-Warshall algorithm only works for graphs
	 *             without negative cycles
