...
public class mxGeometry extends mxRectangle {
	 ...
	 * targetPoint and sourcePoint or set the terminals of the edge to a
	 * non-null value. Default is null.
	 */
	 ...
	 * position, or a relative location with respect to a parent cell's width
	 * and height.
	 */
	 ...
	 * alternateBounds and puts the previous values into alternateBounds as a
	 * rectangle. This operation is carried-out in-place, that is, using the
	 ...
	 * geometry is not relative. If TRANSLATE_CONTROL_POINTS is false, then are
