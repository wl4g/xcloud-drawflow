 ...
 */
package com.wl4g.drawflow.swing;
...
import com.wl4g.drawflow.canvas.mxICanvas;
import com.wl4g.drawflow.model.mxGraphModel;
import com.wl4g.drawflow.model.mxGraphModel.Filter;
import com.wl4g.drawflow.model.mxIGraphModel;
import com.wl4g.drawflow.swing.handler.mxCellHandler;
import com.wl4g.drawflow.swing.handler.mxConnectionHandler;
import com.wl4g.drawflow.swing.handler.mxEdgeHandler;
import com.wl4g.drawflow.swing.handler.mxElbowEdgeHandler;
import com.wl4g.drawflow.swing.handler.mxGraphHandler;
import com.wl4g.drawflow.swing.handler.mxGraphTransferHandler;
import com.wl4g.drawflow.swing.handler.mxPanningHandler;
import com.wl4g.drawflow.swing.handler.mxSelectionCellsHandler;
import com.wl4g.drawflow.swing.handler.mxVertexHandler;
import com.wl4g.drawflow.swing.util.mxCellOverlay;
import com.wl4g.drawflow.swing.util.mxICellOverlay;
import com.wl4g.drawflow.swing.view.mxCellEditor;
import com.wl4g.drawflow.swing.view.mxICellEditor;
import com.wl4g.drawflow.swing.view.mxInteractiveCanvas;
...
import com.wl4g.drawflow.util.mxEventSource.mxIEventListener;
import com.wl4g.drawflow.util.mxPoint;
import com.wl4g.drawflow.util.mxRectangle;
import com.wl4g.drawflow.util.mxResources;
import com.wl4g.drawflow.util.mxUtils;
import com.wl4g.drawflow.view.mxCellState;
import com.wl4g.drawflow.view.mxEdgeStyle;
import com.wl4g.drawflow.view.mxEdgeStyle.mxEdgeStyleFunction;
import com.wl4g.drawflow.view.mxGraph;
import com.wl4g.drawflow.view.mxGraphView;
import com.wl4g.drawflow.view.mxTemporaryCellStates;
...
public class mxGraphComponent extends JScrollPane implements Printable {
	...
	public mxInteractiveCanvas createCanvas() {
		// NOTE: http://forum.jgraph.com/questions/3354/ reports that we should
		// not
	 ...
	 * @seecom.wl4g.drawflow.util.mxEventSource#isEventsEnabled()
	 */
	...
	/**
	 * @param eventsEnabled
	 * @seecom.wl4g.drawflow.util.mxEventSource#setEventsEnabled(boolean)
	 */
	 ...
	 * @param eventName
	 * @param listener
	 * @seecom.wl4g.drawflow.util.mxEventSource#addListener(java.lang.String,
	 *     com.wl4g.drawflow.util.mxEventSource.mxIEventListener)
	 */
	...
	public class mxGraphControl extends JComponent {
		...
		/**
		 * @param state
		 *            the cached state of the cell whose extended bounds are to
		 *            be calculated
		 * @return the bounds of the cell, including the label and shadow and
