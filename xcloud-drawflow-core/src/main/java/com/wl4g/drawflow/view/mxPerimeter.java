...
public class mxPerimeter {
	...
	public interface mxPerimeterFunction {
		 ...
		 *            the perimeter should be returned. If this is false then
		 *            the intersection of the perimeter and the line between the
		 *            next and the center point is returned.
	...
	public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction() {
		 ...
		 * (non-Javadoc)
		 * 
		 * @seecom.wl4g.drawflow.view.mxPerimeter.mxPerimeterFunction#apply
		 */
	...
	/**
	 * Describes a triangle perimeter. See RectanglePerimeter for a description
	 * of the parameters.
	 */
	public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction() {
		 ...
		 * 
		 * @see
		 *com.wl4g.drawflow.view.mxPerimeter.mxPerimeterFunction#apply(com.mxgraph.
		 * utils.mxRectangle,com.wl4g.drawflow.view.mxCellState,
		 *com.wl4g.drawflow.view.mxCellState, boolean,com.wl4g.drawflow.utils.mxPoint)
		 */
		public mxPoint apply(mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) {
