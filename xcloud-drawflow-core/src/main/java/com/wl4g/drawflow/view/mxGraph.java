...
import com.wl4g.drawflow.canvas.mxImageCanvas;
import com.wl4g.drawflow.model.mxCell;
...
import com.wl4g.drawflow.model.mxGraphModel.mxChildChange;
import com.wl4g.drawflow.model.mxGraphModel.mxCollapseChange;
import com.wl4g.drawflow.model.mxGraphModel.mxGeometryChange;
import com.wl4g.drawflow.model.mxGraphModel.mxRootChange;
import com.wl4g.drawflow.model.mxGraphModel.mxStyleChange;
import com.wl4g.drawflow.model.mxGraphModel.mxTerminalChange;
import com.wl4g.drawflow.model.mxGraphModel.mxValueChange;
import com.wl4g.drawflow.model.mxGraphModel.mxVisibleChange;
import com.wl4g.drawflow.model.mxICell;
...
public class mxGraph extends mxEventSource {
	 ...
	 * returns true. The value specifies the portion of the child which is
	 * allowed to overlap the parent.
	 */
	 ...
	 * is not in the given array, then the respective end is assigned a terminal
							...
							if (state != null && pstate != null) {
								...
								if (model.isEdge(clones[i])) {
									...
									if (src == null) {
										...
										g.setTerminalPoint(
												new mxPoint(pt.getX() / scale - trans.getX(), pt.getY() / scale - trans.getY()),
												true);
									}
							...
							if (geo != null) {
								...
								if (state != null) {
									...
									geo.setTerminalPoint(
											new mxPoint(pt.getX() / scale - tr.getX(), pt.getY() / scale - tr.getY()), source);
			...
			try {
				...
				if (constraint == null || constraint.point == null) {
					...
					if (!constraint.perimeter) {
						setCellStyles((source) ? mxConstants.STYLE_EXIT_PERIMETER : mxConstants.STYLE_ENTRY_PERIMETER, "0",
								cells);
					} else {
	...
	public mxPoint getConnectionPoint(mxCellState vertex, mxConnectionConstraint constraint) {
		...
		if (vertex != null && constraint.point != null) {
			...
			if (direction != null) {
				...
				// Bounds need to be rotated by 90 degrees for further
				// computation
	...
	public Object connectCell(Object edge, Object terminal, boolean source, mxConnectionConstraint constraint) {
		...
		try {
			...
			fireEvent(new mxEventObject(mxEvent.CONNECT_CELL, "edge", edge, "terminal", terminal, "source", source, "previous",
					previous));
		} finally {
			model.endUpdate();
		}
