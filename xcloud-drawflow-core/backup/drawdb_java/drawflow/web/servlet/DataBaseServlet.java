...
import com.wl4g.drawflow.utils.DBHelper;
import com.wl4g.drawflow.utils.HttpUtil;
...
public class DataBaseServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			if (null != request.getParameter("method") && request.getParameter("method").equalsIgnoreCase("save")
					&& null != request.getParameter("content")) { // 保存方法
				this.save(request, response);
			} else if (null != request.getParameter("method") && request.getParameter("method").equalsIgnoreCase("list")) { // 保存方法
				this.list(request, response);
			} else if (null != request.getParameter("method") && request.getParameter("method").equalsIgnoreCase("getHtml")
	...
	private void save(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		dbHelper.excuteUpdate(" INSERT INTO qjjs_draw_content(  name , content, create_date) VALUES (  ?,?, ?) ", updParams);
