...
import com.wl4g.drawflow.io.graphml.mxGraphMlConstants;
import com.wl4g.drawflow.io.graphml.mxGraphMlData;
import com.wl4g.drawflow.io.graphml.mxGraphMlEdge;
import com.wl4g.drawflow.io.graphml.mxGraphMlGraph;
import com.wl4g.drawflow.io.graphml.mxGraphMlKey;
import com.wl4g.drawflow.io.graphml.mxGraphMlKeyManager;
import com.wl4g.drawflow.io.graphml.mxGraphMlNode;
import com.wl4g.drawflow.io.graphml.mxGraphMlShapeEdge;
import com.wl4g.drawflow.io.graphml.mxGraphMlShapeNode;
import com.wl4g.drawflow.io.graphml.mxGraphMlUtils;
...
public class mxGraphMlCodec {
	...
	private static void createKeyElements() {
		HashMap<String, mxGraphMlKey> keyMap = mxGraphMlKeyManager.getInstance().getKeyMap();
		mxGraphMlKey keyNode = new mxGraphMlKey(mxGraphMlConstants.KEY_NODE_ID, mxGraphMlKey.keyForValues.NODE,
				mxGraphMlConstants.KEY_NODE_NAME, mxGraphMlKey.keyTypeValues.STRING);
		keyMap.put(mxGraphMlConstants.KEY_NODE_ID, keyNode);
		mxGraphMlKey keyEdge = new mxGraphMlKey(mxGraphMlConstants.KEY_EDGE_ID, mxGraphMlKey.keyForValues.EDGE,
				mxGraphMlConstants.KEY_EDGE_NAME, mxGraphMlKey.keyTypeValues.STRING);
