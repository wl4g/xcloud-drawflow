 ...
 * document. The key elements are wrapped in instances of mxGmlKey and may to be
 * access by ID.
 */
public class mxGraphMlKeyManager {
	...
	/**
	 * Returns the instance of mxGmlKeyManager. If no instance has been created
	 * until the moment, a new instance is returned. This method don't load the
	 * map.
	 * 
