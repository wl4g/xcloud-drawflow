...
public class mxGraphMlUtils {
	 ...
	 * @param tag
	 *            Name of the node.
	 * @return Returns <code>true</code> if the Node List has a Node with name =
	 *         tag.
	 */
	...
	/**
	 * Returns a list with the elements included in the Node List that have name
	 * = tag.
	 * 
	 * @param nl
	 *            NodeList
	 ...
	 * @param tag
	 *            Name of the node.
	 * @return Returns <code>true</code> if the childrens of element has a Node
	 *         with name = tag.
	 */
	...
	/**
	 * Returns the first Element that has name = tag in the childrens of
	 * element.
	 * 
	 * @param element
	 *            Element
