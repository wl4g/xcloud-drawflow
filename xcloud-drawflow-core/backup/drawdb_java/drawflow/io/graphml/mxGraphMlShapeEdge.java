...
public class mxGraphMlShapeEdge {
	...
	public Element generateElement(Document document) {
		...
		if (!this.text.equals("")) {
			Element dataEdgeLabel = document.createElementNS(mxGraphMlConstants.JGRAPH_URL,
		...
		if (!this.style.equals("")) {
			Element dataEdgeStyle = document.createElementNS(mxGraphMlConstants.JGRAPH_URL,
