...
public class mxGraphMlShapeNode {
	...
	public Element generateElement(Document document) {
		...
		Element dataShapeGeometry = document.createElementNS(mxGraphMlConstants.JGRAPH_URL,
				mxGraphMlConstants.JGRAPH + mxGraphMlConstants.GEOMETRY);
		...
		if (!this.dataStyle.equals("")) {
			Element dataShapeStyle = document.createElementNS(mxGraphMlConstants.JGRAPH_URL,
		...
		if (!this.dataLabel.equals("")) {
			...
			Element dataShapeLabel = document.createElementNS(mxGraphMlConstants.JGRAPH_URL,
