 ...
 */
package com.wl4g.drawflow.io.graphml;
...
public class mxGraphMlKey {
	...
	/**
	 * Returns the default value of the keyDefault attribute according the
	 * keyType.
	 */
	...
	/**
	 * Converts a String value in its corresponding enum value for the keyFor
	 * attribute.
	 * 
	 * @param value
	...
	/**
	 * Converts a enum value in its corresponding String value for the keyFor
	 * attribute.
	 * 
	 * @param value
	...
	/**
	 * Converts a String value in its corresponding enum value for the keyType
	 * attribute.
	 * 
	 * @param value
	 *            Value in String representation.
	...
	/**
	 * Converts a enum value in its corresponding string value for the keyType
	 * attribute.
	 * 
	 * @param value
	 *            Value in enum representation.
